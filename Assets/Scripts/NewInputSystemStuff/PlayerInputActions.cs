...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/NewInputSystemStuff/PlayerInputActions.inputactions".
/// </summary>
/// <remarks>
...
public partial class @PlayerInputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@PlayerInputActions()
    {
        ...
        UnityEngine.Debug.Assert(!m_FreeFlyCamControls.enabled, "This will cause a leak and performance issues, PlayerInputActions.FreeFlyCamControls.Disable() has not been called.");
    }
    ...
    public struct PlayerControlsActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "PlayerControls/Ascend".
        /// </summary>
        public InputAction @Ascend => m_Wrapper.m_PlayerControls_Ascend;
        /// <summary>
        /// Provides access to the underlying input action "PlayerControls/Descend".
        /// </summary>
        public InputAction @Descend => m_Wrapper.m_PlayerControls_Descend;
        /// <summary>
        /// Provides access to the underlying input action "PlayerControls/Knife".
        /// </summary>
        ...
        /// <summary>
        /// Provides access to the underlying input action "PlayerControls/Invisibility".
        /// </summary>
        public InputAction @Invisibility => m_Wrapper.m_PlayerControls_Invisibility;
        /// <summary>
        /// Provides access to the underlying input action "PlayerControls/Flashlight".
        /// </summary>
        public InputAction @Flashlight => m_Wrapper.m_PlayerControls_Flashlight;
        /// <summary>
        /// Provides access to the underlying input action "PlayerControls/Blacklight".
        /// </summary>
    ...
    public struct MenuControlsActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "MenuControls/Newaction".
        /// </summary>
    ...
    private List<IFreeFlyCamControlsActions> m_FreeFlyCamControlsActionsCallbackInterfaces = new List<IFreeFlyCamControlsActions>();
    ...
    /// <summary>
    /// Provides access to input actions defined in input action map "FreeFlyCamControls".
    /// </summary>
    public struct FreeFlyCamControlsActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "FreeFlyCamControls/Movement".
        /// </summary>
        public InputAction @Movement => m_Wrapper.m_FreeFlyCamControls_Movement;
        /// <summary>
        /// Provides access to the underlying input action "FreeFlyCamControls/Look".
        /// </summary>
        public InputAction @Look => m_Wrapper.m_FreeFlyCamControls_Look;
        /// <summary>
        /// Provides access to the underlying input action "FreeFlyCamControls/Up".
        /// </summary>
        public InputAction @Up => m_Wrapper.m_FreeFlyCamControls_Up;
        /// <summary>
        /// Provides access to the underlying input action "FreeFlyCamControls/Down".
        /// </summary>
        public InputAction @Down => m_Wrapper.m_FreeFlyCamControls_Down;
        /// <summary>
        /// Provides access to the underlying input action "FreeFlyCamControls/SpeedUp".
        /// </summary>
        public InputAction @SpeedUp => m_Wrapper.m_FreeFlyCamControls_SpeedUp;
        /// <summary>
        /// Provides access to the underlying input action "FreeFlyCamControls/SlowDown".
        /// </summary>
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="FreeFlyCamControlsActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="FreeFlyCamControlsActions" />
        public void AddCallbacks(IFreeFlyCamControlsActions instance)
        {
            if (instance == null || m_Wrapper.m_FreeFlyCamControlsActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_FreeFlyCamControlsActionsCallbackInterfaces.Add(instance);
            @Movement.started += instance.OnMovement;
            @Movement.performed += instance.OnMovement;
            @Movement.canceled += instance.OnMovement;
            @Look.started += instance.OnLook;
        ...
        /// </remarks>
        /// <seealso cref="FreeFlyCamControlsActions" />
        private void UnregisterCallbacks(IFreeFlyCamControlsActions instance)
        {
            @Movement.started -= instance.OnMovement;
            @Movement.performed -= instance.OnMovement;
            @Movement.canceled -= instance.OnMovement;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="FreeFlyCamControlsActions.UnregisterCallbacks(IFreeFlyCamControlsActions)" />.
        /// </summary>
        /// <seealso cref="FreeFlyCamControlsActions.UnregisterCallbacks(IFreeFlyCamControlsActions)" />
        public void RemoveCallbacks(IFreeFlyCamControlsActions instance)
        {
            if (m_Wrapper.m_FreeFlyCamControlsActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="FreeFlyCamControlsActions.AddCallbacks(IFreeFlyCamControlsActions)" />
        /// <seealso cref="FreeFlyCamControlsActions.RemoveCallbacks(IFreeFlyCamControlsActions)" />
        /// <seealso cref="FreeFlyCamControlsActions.UnregisterCallbacks(IFreeFlyCamControlsActions)" />
        public void SetCallbacks(IFreeFlyCamControlsActions instance)
        {
            foreach (var item in m_Wrapper.m_FreeFlyCamControlsActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_FreeFlyCamControlsActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="FreeFlyCamControlsActions" /> instance referencing this action map.
    /// </summary>
    ...
    public interface IPlayerControlsActions
    {
        ...
        /// <summary>
        /// Method invoked when associated input action "Blacklight" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "FreeFlyCamControls" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="FreeFlyCamControlsActions.AddCallbacks(IFreeFlyCamControlsActions)" />
    /// <seealso cref="FreeFlyCamControlsActions.RemoveCallbacks(IFreeFlyCamControlsActions)" />
